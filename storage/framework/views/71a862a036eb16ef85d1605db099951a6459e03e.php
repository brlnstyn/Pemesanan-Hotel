                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo e($reservation->nama_tamu); ?></td>
                                        <td><?php echo e($reservation->tgl_check_in); ?></td>
                                        <td><?php echo e($reservation->tgl_check_out); ?></td>
                                        <td>
                                            <?php if(date('Y-m-d') < $reservation['tgl_check_in']): ?> Booking <?php elseif(date('Y-m-d')>= $reservation['tgl_check_in'] && date('Y-m-d') < $reservation['tgl_check_out']): ?> Check In <?php elseif(date('Y-m-d')>= $reservation['tgl_check_out']): ?>
                                                    Check Out
                                                    <?php endif; ?>
                                        </td>
                                    </tr>
...
</html><?php /**PATH C:\xampp\htdocs\LARAVEL\PemesananHotel\resources\views/dashboards/receptionist/index.blade.php ENDPATH**/ ?>