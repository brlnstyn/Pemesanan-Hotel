...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <!-- Navbar Search-->
            <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0" action="route<?php echo e('filterreservation'); ?>" method= "GET">
                <div class="input-group">
                    <input class="form-control" type="date" aria-describedby="btnNavbarSearch" name="filterreservation" >
...
<?php /**PATH C:\xampp\htdocs\LARAVEL\PemesananHotel\resources\views/layout/king.blade.php ENDPATH**/ ?>